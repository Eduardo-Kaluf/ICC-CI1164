...
\begin{document}
    ...
    Ou seja, o aumento dessa métrica ocorreu tanto por uma diminuição no tempo total necessário para realizar as operações quanto por um aumento na velocidade geral do processamento.
    ...
    Essa maior \textit{taxa de miss} ocorre, principalmente, pelos acessos indiretos e distantes que o cálculo do resíduo acaba fazendo por conta do CSR\@.
