...
n_vals = np.array(["32", "64", "128", "256", "512", "1K", "2K", "4K", "8K", "9K", "10K", "20K"])
...
for operation, op_info in OP_MAP.items():
    ...
    for metric in metrics:
        ...
        raw_values_opt    = [allData[operation]["optimized"]   [metric][n] / div_factor for n in n_vals_str]
        raw_values_nonopt = [allData[operation]["nonOptimized"][metric][n] / div_factor for n in n_vals_str]
