...
\begin{document}
    ...
    \subsection{ Método dos Gradientes Conjugados (CG)}
    \includegraphics[width=16cm]{graphs/op1_gradient_Exec_Time.png}
    \includegraphics[width=4cm]{graphs/op1_gradient_Flops_Avx.png}
    \includegraphics[width=4cm]{graphs/op1_gradient_Flops_Dp.png}
    \includegraphics[width=4cm]{graphs/op1_gradient_L2Cache.png}
    \includegraphics[width=4cm]{graphs/op1_gradient_L3.png}
    \subsection{Cálculo do Resíduo}
    \includegraphics[width=4cm]{graphs/op2_residue_Exec_Time.png}
    \includegraphics[width=4cm]{graphs/op2_residue_Flops_Avx.png}
    \includegraphics[width=4cm]{graphs/op2_residue_Flops_Dp.png}
    \includegraphics[width=4cm]{graphs/op2_residue_L2Cache.png}
    \includegraphics[width=4cm]{graphs/op2_residue_L3.png}
